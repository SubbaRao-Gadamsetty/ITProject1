...
class Incident:
    ...
    def __init__(self, incident_id: str, title: str, description: str,
        ...
        self.notes = []
        # Support for additional metadata like JIRA issue keys
        self.metadata = {}
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        # Include any metadata fields (like jira_issue_key)
...
def set_incident_metadata(incident_id: str, key: str, value: Any) -> bool:
    """Set a metadata key/value on an incident (persists to the Incident object).

    Returns True if the incident exists and was updated, False otherwise.
    """
    if incident_id not in _incidents:
        return False

    _incidents[incident_id].metadata[key] = value
    _incidents[incident_id].updated_time = datetime.datetime.now().isoformat()
    return True
